/**
 * Ancien alias de la commande historique "run v10 migration".
 *
 * Role:
 ...
 * - les vrais changements sont definis dans `migration_v10.sql` et `migration_v10.js`
 */
import { runDeprecatedMigrationScript } from "./legacy-runner.js";

await runDeprecatedMigrationScript("run-migration-v10.js");
