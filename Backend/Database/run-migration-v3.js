/**
 * Ancien alias de la commande historique "run v3 migration".
 *
 * Role:
 ...
 * - les vrais changements sont definis dans `migration_v3.sql` et `migration_v3.js`
 */
import { runDeprecatedMigrationScript } from "./legacy-runner.js";

await runDeprecatedMigrationScript("run-migration-v3.js");
