...
![Tableau de bord -- Horaires-5](./images/dashboard.png)

*Tableau de bord de pilotage : vue synthetique de la session active avec indicateurs cles,
couverture etudiante et suivi en temps reel.*
...
**Saber Kara** -- **Rafik Bedreddin** -- **Jovani Clement**
